...
class VocabEncoder():
    ...
    # Creation of the dictionary by traversing the whole JSON (questions or answers)
    ...
    # Encoding of a sentence (question or answer) from the dictionary created earlier.
    ...
    # Decode a sentence (only used for displaying results)
